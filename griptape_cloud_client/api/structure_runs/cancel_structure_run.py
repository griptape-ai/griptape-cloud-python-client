...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/structure-runs/{structure_run_id}/cancel",
    }
...
) -> Optional[Union[CancelStructureRunResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]]:
