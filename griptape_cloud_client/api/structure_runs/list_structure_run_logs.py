...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/structure-runs/{structure_run_id}/logs",
    }
...
) -> Optional[Union[ClientErrorResponseContent, ListStructureRunLogsResponseContent, ServiceErrorResponseContent]]:
