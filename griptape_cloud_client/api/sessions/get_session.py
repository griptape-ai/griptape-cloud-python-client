...
from ...models.get_session_response_content import GetSessionResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, GetSessionResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetSessionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, GetSessionResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetSessionResponseContent, ServiceErrorResponseContent]
    """
