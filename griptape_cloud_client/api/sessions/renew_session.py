...
from ...models.renew_session_response_content import RenewSessionResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, RenewSessionResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = RenewSessionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, RenewSessionResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, RenewSessionResponseContent, ServiceErrorResponseContent]
    """
