...
from ...models.update_session_request_content import UpdateSessionRequestContent
from ...models.update_session_response_content import UpdateSessionResponseContent
...
def _get_kwargs(
    session_id: str,
    *,
    body: UpdateSessionRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateSessionResponseContent]]:
    if response.status_code == 200:
        response_200 = UpdateSessionResponseContent.from_dict(response.json())
