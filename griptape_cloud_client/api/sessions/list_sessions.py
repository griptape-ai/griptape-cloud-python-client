...
from ...models.list_sessions_response_content import ListSessionsResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, ListSessionsResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = ListSessionsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, ListSessionsResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListSessionsResponseContent, ServiceErrorResponseContent]
    """
