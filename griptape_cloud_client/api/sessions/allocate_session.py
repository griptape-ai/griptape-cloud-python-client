...
from ...models.allocate_session_request_content import AllocateSessionRequestContent
from ...models.allocate_session_response_content import AllocateSessionResponseContent
...
def _get_kwargs(
    *,
    body: AllocateSessionRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[AllocateSessionResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = AllocateSessionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AllocateSessionResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[AllocateSessionResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]
    """
