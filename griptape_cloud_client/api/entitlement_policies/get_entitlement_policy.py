...
from ...models.get_entitlement_policy_response_content import GetEntitlementPolicyResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/entitlement-policies/{entitlement_policy_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, GetEntitlementPolicyResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetEntitlementPolicyResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, GetEntitlementPolicyResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetEntitlementPolicyResponseContent, ServiceErrorResponseContent]
    """
