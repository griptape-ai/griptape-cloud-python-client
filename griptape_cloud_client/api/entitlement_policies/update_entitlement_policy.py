...
from ...models.update_entitlement_policy_request_content import UpdateEntitlementPolicyRequestContent
from ...models.update_entitlement_policy_response_content import UpdateEntitlementPolicyResponseContent
...
def _get_kwargs(
    ...
    *,
    body: UpdateEntitlementPolicyRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateEntitlementPolicyResponseContent]]:
    if response.status_code == 200:
        response_200 = UpdateEntitlementPolicyResponseContent.from_dict(response.json())
