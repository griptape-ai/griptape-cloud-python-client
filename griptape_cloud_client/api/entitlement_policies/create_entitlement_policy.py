...
from ...models.create_entitlement_policy_request_content import CreateEntitlementPolicyRequestContent
from ...models.create_entitlement_policy_response_content import CreateEntitlementPolicyResponseContent
...
def _get_kwargs(
    *,
    body: CreateEntitlementPolicyRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, CreateEntitlementPolicyResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = CreateEntitlementPolicyResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, CreateEntitlementPolicyResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateEntitlementPolicyResponseContent, ServiceErrorResponseContent]
    """
