...
from ...models.create_import_job_request_content import CreateImportJobRequestContent
from ...models.create_import_job_response_content import CreateImportJobResponseContent
...
def _get_kwargs(
    *,
    body: CreateImportJobRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, CreateImportJobResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = CreateImportJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, CreateImportJobResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateImportJobResponseContent, ServiceErrorResponseContent]
    """
