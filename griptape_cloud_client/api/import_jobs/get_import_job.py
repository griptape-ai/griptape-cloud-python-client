...
from ...models.get_import_job_response_content import GetImportJobResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/import-jobs/{import_job_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, GetImportJobResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetImportJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, GetImportJobResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetImportJobResponseContent, ServiceErrorResponseContent]
    """
