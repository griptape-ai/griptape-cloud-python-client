...
from ...models.list_import_jobs_response_content import ListImportJobsResponseContent
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, list[ImportJobStatus]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ListImportJobsResponseContent.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (Union[Unset, list[ImportJobStatus]]): Comma-separated list of statuses to filter
            by.
