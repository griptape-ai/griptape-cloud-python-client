...
from ...models.start_import_job_response_content import StartImportJobResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/import-jobs/{import_job_id}/start",
    }
...
) -> Optional[Union[ClientErrorResponseContent, ServiceErrorResponseContent, StartImportJobResponseContent]]:
    if response.status_code == 200:
        response_200 = StartImportJobResponseContent.from_dict(response.json())
