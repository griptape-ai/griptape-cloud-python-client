...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/knowledge-bases/{knowledge_base_id}/knowledge-base-jobs",
    }
...
) -> Optional[Union[ClientErrorResponseContent, CreateKnowledgeBaseJobResponseContent, ServiceErrorResponseContent]]:
