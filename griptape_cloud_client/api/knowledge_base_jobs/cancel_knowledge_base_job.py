...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/knowledge-base-jobs/{knowledge_base_job_id}/cancel",
    }
...
) -> Optional[Union[CancelKnowledgeBaseJobResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]]:
