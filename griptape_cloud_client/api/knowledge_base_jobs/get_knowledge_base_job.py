...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/knowledge-base-jobs/{knowledge_base_job_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, GetKnowledgeBaseJobResponseContent, ServiceErrorResponseContent]]:
