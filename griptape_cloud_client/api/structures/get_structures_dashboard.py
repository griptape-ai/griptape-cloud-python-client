...
def _get_kwargs(
    *,
    ...
    period: Union[Unset, Period] = UNSET,
    structure_ids: Union[Unset, str] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ClientErrorResponseContent, GetStructuresDashboardResponseContent, ServiceErrorResponseContent]]:
