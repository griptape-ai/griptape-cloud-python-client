...
from ...models.create_license_group_request_content import CreateLicenseGroupRequestContent
from ...models.create_license_group_response_content import CreateLicenseGroupResponseContent
...
def _get_kwargs(
    *,
    body: CreateLicenseGroupRequestContent,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/license-groups",
    }
...
) -> Optional[Union[ClientErrorResponseContent, CreateLicenseGroupResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = CreateLicenseGroupResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, CreateLicenseGroupResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateLicenseGroupResponseContent, ServiceErrorResponseContent]
    """
