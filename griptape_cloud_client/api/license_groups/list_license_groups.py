...
from ...models.list_license_groups_response_content import ListLicenseGroupsResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, ListLicenseGroupsResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = ListLicenseGroupsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, ListLicenseGroupsResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListLicenseGroupsResponseContent, ServiceErrorResponseContent]
    """
