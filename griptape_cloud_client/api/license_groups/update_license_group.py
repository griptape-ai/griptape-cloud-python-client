...
from ...models.update_license_group_request_content import UpdateLicenseGroupRequestContent
from ...models.update_license_group_response_content import UpdateLicenseGroupResponseContent
...
def _get_kwargs(
    ...
    *,
    body: UpdateLicenseGroupRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateLicenseGroupResponseContent]]:
    if response.status_code == 200:
        response_200 = UpdateLicenseGroupResponseContent.from_dict(response.json())
