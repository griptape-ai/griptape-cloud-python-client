...
def _get_kwargs(
    ...
    *,
    ...
    status: Union[Unset, list[ToolRunStatus]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ClientErrorResponseContent, ListToolRunsResponseContent, ServiceErrorResponseContent]]:
