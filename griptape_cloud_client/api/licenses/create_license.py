...
from ...models.create_license_request_content import CreateLicenseRequestContent
from ...models.create_license_response_content import CreateLicenseResponseContent
...
def _get_kwargs(
    *,
    body: CreateLicenseRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, CreateLicenseResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = CreateLicenseResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, CreateLicenseResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateLicenseResponseContent, ServiceErrorResponseContent]
    """
