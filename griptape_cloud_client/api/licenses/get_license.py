...
from ...models.get_license_response_content import GetLicenseResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, GetLicenseResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetLicenseResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, GetLicenseResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetLicenseResponseContent, ServiceErrorResponseContent]
    """
