...
from ...models.update_license_request_content import UpdateLicenseRequestContent
from ...models.update_license_response_content import UpdateLicenseResponseContent
...
def _get_kwargs(
    license_id: str,
    *,
    body: UpdateLicenseRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateLicenseResponseContent]]:
    if response.status_code == 200:
        response_200 = UpdateLicenseResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateLicenseResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateLicenseResponseContent]
    """
