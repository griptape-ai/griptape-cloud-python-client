...
from ...models.get_auth_config_response_content import GetAuthConfigResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, GetAuthConfigResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetAuthConfigResponseContent.from_dict(response.json())
