...
from ...models.create_model_request_content import CreateModelRequestContent
from ...models.create_model_response_content import CreateModelResponseContent
...
def _get_kwargs(
    *,
    body: CreateModelRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, CreateModelResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = CreateModelResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, CreateModelResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateModelResponseContent, ServiceErrorResponseContent]
    """
