...
from ...models.list_auth_configs_response_content import ListAuthConfigsResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, ListAuthConfigsResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = ListAuthConfigsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, ListAuthConfigsResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListAuthConfigsResponseContent, ServiceErrorResponseContent]
    """
