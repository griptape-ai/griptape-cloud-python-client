...
from ...models.create_auth_config_request_content import CreateAuthConfigRequestContent
from ...models.create_auth_config_response_content import CreateAuthConfigResponseContent
...
def _get_kwargs(
    *,
    body: CreateAuthConfigRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, CreateAuthConfigResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 201:
        response_201 = CreateAuthConfigResponseContent.from_dict(response.json())
