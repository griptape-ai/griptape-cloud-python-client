...
from ...models.update_model_request_content import UpdateModelRequestContent
from ...models.update_model_response_content import UpdateModelResponseContent
...
def _get_kwargs(
    model_config_id: str,
    *,
    body: UpdateModelRequestContent,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/models/{model_config_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateModelResponseContent]]:
    if response.status_code == 200:
        response_200 = UpdateModelResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateModelResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateModelResponseContent]
    """
