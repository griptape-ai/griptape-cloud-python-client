...
from ...models.get_model_response_content import GetModelResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, GetModelResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetModelResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, GetModelResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetModelResponseContent, ServiceErrorResponseContent]
    """
