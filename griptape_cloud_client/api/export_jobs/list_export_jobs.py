...
from ...models.list_export_jobs_response_content import ListExportJobsResponseContent
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, list[ExportJobStatus]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ClientErrorResponseContent, ListExportJobsResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = ListExportJobsResponseContent.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (Union[Unset, list[ExportJobStatus]]): Comma-separated list of statuses to filter
            by.
