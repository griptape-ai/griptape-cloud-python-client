...
from ...models.create_export_job_request_content import CreateExportJobRequestContent
from ...models.create_export_job_response_content import CreateExportJobResponseContent
...
def _get_kwargs(
    *,
    body: CreateExportJobRequestContent,
) -> dict[str, Any]:
...
) -> Optional[Union[ClientErrorResponseContent, CreateExportJobResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 202:
        response_202 = CreateExportJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, CreateExportJobResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateExportJobResponseContent, ServiceErrorResponseContent]
    """
