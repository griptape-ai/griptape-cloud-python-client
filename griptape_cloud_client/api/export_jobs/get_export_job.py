...
from ...models.get_export_job_response_content import GetExportJobResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/export-jobs/{export_job_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, GetExportJobResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetExportJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ClientErrorResponseContent, GetExportJobResponseContent, ServiceErrorResponseContent]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetExportJobResponseContent, ServiceErrorResponseContent]
    """
