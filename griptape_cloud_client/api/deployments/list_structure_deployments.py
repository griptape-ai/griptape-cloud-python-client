...
def _get_kwargs(
    ...
    *,
    ...
    status: Union[Unset, list[DeploymentStatus]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ClientErrorResponseContent, ListStructureDeploymentsResponseContent, ServiceErrorResponseContent]]:
