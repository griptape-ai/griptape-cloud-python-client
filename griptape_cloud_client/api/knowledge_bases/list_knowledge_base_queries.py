...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/knowledge-bases/{knowledge_base_id}/queries",
        "params": params,
    }
...
) -> Optional[Union[ClientErrorResponseContent, ListKnowledgeBaseQueriesResponseContent, ServiceErrorResponseContent]]:
