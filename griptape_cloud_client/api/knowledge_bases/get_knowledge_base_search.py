...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/knowledge-base-searches/{knowledge_base_search_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, GetKnowledgeBaseSearchResponseContent, ServiceErrorResponseContent]]:
