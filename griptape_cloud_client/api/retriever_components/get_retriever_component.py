...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/retriever-components/{retriever_component_id}",
    }
...
) -> Optional[Union[ClientErrorResponseContent, GetRetrieverComponentResponseContent, ServiceErrorResponseContent]]:
