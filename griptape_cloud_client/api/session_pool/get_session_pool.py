...
from ...models.get_session_pool_response_content import GetSessionPoolResponseContent
...
) -> Optional[Union[ClientErrorResponseContent, GetSessionPoolResponseContent, ServiceErrorResponseContent]]:
    if response.status_code == 200:
        response_200 = GetSessionPoolResponseContent.from_dict(response.json())
