...
T = TypeVar("T", bound="UpdateOrganizationResponseContent")


@_attrs_define
class UpdateOrganizationResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_organization_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            default_bucket_id=default_bucket_id,
            description=description,
        ...
        update_organization_response_content.additional_properties = d
        return update_organization_response_content
