...
T = TypeVar("T", bound="CreateModelResponseContent")


@_attrs_define
class CreateModelResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_model_response_content = cls(
            created_at=created_at,
            default=default,
            model_name=model_name,
            model_type=model_type,
        ...
        create_model_response_content.additional_properties = d
        return create_model_response_content
