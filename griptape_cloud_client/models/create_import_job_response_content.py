...
T = TypeVar("T", bound="CreateImportJobResponseContent")


@_attrs_define
class CreateImportJobResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_import_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            data_lake_asset_path=data_lake_asset_path,
            import_job_id=import_job_id,
        ...
        create_import_job_response_content.additional_properties = d
        return create_import_job_response_content
