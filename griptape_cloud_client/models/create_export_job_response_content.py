...
T = TypeVar("T", bound="CreateExportJobResponseContent")


@_attrs_define
class CreateExportJobResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_export_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            export_job_id=export_job_id,
            organization_id=organization_id,
        ...
        create_export_job_response_content.additional_properties = d
        return create_export_job_response_content
