...
T = TypeVar("T", bound="CreateLicenseGroupResponseContent")


@_attrs_define
class CreateLicenseGroupResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_license_group_response_content = cls(
            created_at=created_at,
            license_group_id=license_group_id,
            name=name,
            organization_id=organization_id,
        ...
        create_license_group_response_content.additional_properties = d
        return create_license_group_response_content
