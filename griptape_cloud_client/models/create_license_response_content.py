...
T = TypeVar("T", bound="CreateLicenseResponseContent")


@_attrs_define
class CreateLicenseResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_license_response_content = cls(
            created_at=created_at,
            expires_at=expires_at,
            license_id=license_id,
            license_token=license_token,
        ...
        create_license_response_content.additional_properties = d
        return create_license_response_content
