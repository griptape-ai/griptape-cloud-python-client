...
T = TypeVar("T", bound="GetImportJobResponseContent")


@_attrs_define
class GetImportJobResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_import_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            data_lake_asset_path=data_lake_asset_path,
            import_job_id=import_job_id,
        ...
        get_import_job_response_content.additional_properties = d
        return get_import_job_response_content
