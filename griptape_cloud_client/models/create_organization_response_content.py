...
T = TypeVar("T", bound="CreateOrganizationResponseContent")
...
class CreateOrganizationResponseContent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_organization_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            default_bucket_id=default_bucket_id,
            description=description,
        ...
        create_organization_response_content.additional_properties = d
