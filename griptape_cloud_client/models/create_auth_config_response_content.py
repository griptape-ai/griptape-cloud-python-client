...
T = TypeVar("T", bound="CreateAuthConfigResponseContent")


@_attrs_define
class CreateAuthConfigResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_auth_config_response_content = cls(
            api_key_secret_id=api_key_secret_id,
            auth_config_id=auth_config_id,
            base_url=base_url,
            created_at=created_at,
        ...
        create_auth_config_response_content.additional_properties = d
        return create_auth_config_response_content
