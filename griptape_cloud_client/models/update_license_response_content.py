...
T = TypeVar("T", bound="UpdateLicenseResponseContent")


@_attrs_define
class UpdateLicenseResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_license_response_content = cls(
            created_at=created_at,
            expires_at=expires_at,
            license_id=license_id,
            license_type=license_type,
        ...
        update_license_response_content.additional_properties = d
        return update_license_response_content
