...
T = TypeVar("T", bound="GetLicenseGroupResponseContent")


@_attrs_define
class GetLicenseGroupResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_license_group_response_content = cls(
            created_at=created_at,
            license_group_id=license_group_id,
            name=name,
            organization_id=organization_id,
        ...
        get_license_group_response_content.additional_properties = d
        return get_license_group_response_content
