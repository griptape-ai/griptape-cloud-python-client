...
T = TypeVar("T", bound="UpdateLicenseGroupResponseContent")


@_attrs_define
class UpdateLicenseGroupResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_license_group_response_content = cls(
            created_at=created_at,
            license_group_id=license_group_id,
            name=name,
            organization_id=organization_id,
        ...
        update_license_group_response_content.additional_properties = d
        return update_license_group_response_content
