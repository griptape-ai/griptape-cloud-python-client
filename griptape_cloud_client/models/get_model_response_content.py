...
T = TypeVar("T", bound="GetModelResponseContent")


@_attrs_define
class GetModelResponseContent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_model_response_content = cls(
            created_at=created_at,
            default=default,
            model_name=model_name,
            model_type=model_type,
        ...
        get_model_response_content.additional_properties = d
        return get_model_response_content
