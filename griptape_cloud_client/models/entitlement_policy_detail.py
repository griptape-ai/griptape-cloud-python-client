...
T = TypeVar("T", bound="EntitlementPolicyDetail")


@_attrs_define
class EntitlementPolicyDetail:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entitlement_policy_detail.additional_properties = d
        return entitlement_policy_detail
