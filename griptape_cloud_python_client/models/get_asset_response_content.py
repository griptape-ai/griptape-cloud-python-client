...
T = TypeVar("T", bound="GetAssetResponseContent")


@_attrs_define
class GetAssetResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_asset_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            name=name,
            organization_id=organization_id,
        ...
        get_asset_response_content.additional_properties = d
