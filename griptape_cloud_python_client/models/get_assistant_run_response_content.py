...
T = TypeVar("T", bound="GetAssistantRunResponseContent")


@_attrs_define
class GetAssistantRunResponseContent:
    """Attributes:
    args (list[str]):
    assistant_id (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_assistant_run_response_content = cls(
            args=args,
            assistant_id=assistant_id,
            assistant_run_id=assistant_run_id,
            completed_at=completed_at,
        ...
        get_assistant_run_response_content.additional_properties = d
        return get_assistant_run_response_content
