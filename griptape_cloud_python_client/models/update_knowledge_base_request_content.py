...
T = TypeVar("T", bound="UpdateKnowledgeBaseRequestContent")


@_attrs_define
class UpdateKnowledgeBaseRequestContent:
    """Attributes:
    ...
    type_: str
    asset_paths: Unset | list[str] = UNSET
    description: Unset | str = UNSET
    embedding_model: Unset | EmbeddingModel = UNSET
    name: Unset | str = UNSET
    schedule_expression: Unset | str = UNSET
    transforms: Unset | list["TransformDetail"] = UNSET
    use_default_embedding_model: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        config: dict[str, Any]
        if (
            isinstance(self.config, KnowledgeBaseConfigInputUnionType0)
            or isinstance(self.config, KnowledgeBaseConfigInputUnionType1)
            or isinstance(self.config, KnowledgeBaseConfigInputUnionType2)
        ):
        ...
        embedding_model: Unset | str = UNSET
        ...
        transforms: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        embedding_model: Unset | EmbeddingModel
        ...
        update_knowledge_base_request_content = cls(
            config=config,
            type_=type_,
        ...
        update_knowledge_base_request_content.additional_properties = d
        return update_knowledge_base_request_content
