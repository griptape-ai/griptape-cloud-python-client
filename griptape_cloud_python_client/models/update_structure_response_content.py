...
T = TypeVar("T", bound="UpdateStructureResponseContent")


@_attrs_define
class UpdateStructureResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_structure_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        update_structure_response_content.additional_properties = d
