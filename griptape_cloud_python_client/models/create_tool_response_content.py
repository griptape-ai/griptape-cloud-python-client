...
T = TypeVar("T", bound="CreateToolResponseContent")


@_attrs_define
class CreateToolResponseContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        code: dict[str, Any]
        if isinstance(self.code, ToolCodeType0) or isinstance(self.code, ToolCodeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_tool_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        create_tool_response_content.additional_properties = d
        return create_tool_response_content
