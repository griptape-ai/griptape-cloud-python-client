...
T = TypeVar("T", bound="UpdateRetrieverComponentResponseContent")


@_attrs_define
class UpdateRetrieverComponentResponseContent:
    """Attributes:
    config (Any):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_retriever_component_response_content = cls(
            config=config,
            created_at=created_at,
            created_by=created_by,
            name=name,
        ...
        update_retriever_component_response_content.additional_properties = d
