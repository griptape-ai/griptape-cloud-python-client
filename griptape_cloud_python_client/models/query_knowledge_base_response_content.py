...
T = TypeVar("T", bound="QueryKnowledgeBaseResponseContent")


@_attrs_define
class QueryKnowledgeBaseResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        query_knowledge_base_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            entries=entries,
            knowledge_base_id=knowledge_base_id,
        ...
        query_knowledge_base_response_content.additional_properties = d
        return query_knowledge_base_response_content
