...
T = TypeVar("T", bound="InvokeStructureWebhookGetResponseContent")


@_attrs_define
class InvokeStructureWebhookGetResponseContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        code: dict[str, Any]
        if isinstance(self.code, StructureCodeType0) or isinstance(self.code, StructureCodeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        invoke_structure_webhook_get_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        invoke_structure_webhook_get_response_content.additional_properties = d
        return invoke_structure_webhook_get_response_content
