...
class OrganizationModelConfig:
    ...
    default_chat_model: Unset | str = UNSET
    default_embedding_model: Unset | str = UNSET
    default_image_generation_model: Unset | str = UNSET
    default_rerank_model: Unset | str = UNSET
