...
class DurationPlot:
    ...
    seconds_avg: Unset | float = UNSET
    seconds_p100: Unset | float = UNSET
    seconds_p50: Unset | float = UNSET
    timeseries: Unset | list["DurationTimeseriesElement"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        timeseries: Unset | list[dict[str, Any]] = UNSET
