...
T = TypeVar("T", bound="GetFunctionResponseContent")


@_attrs_define
class GetFunctionResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_function_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        get_function_response_content.additional_properties = d
