...
T = TypeVar("T", bound="ListUserInvitesResponseContent")


@_attrs_define
class ListUserInvitesResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        list_user_invites_response_content = cls(
            invites=invites,
            pagination=pagination,
        )

        list_user_invites_response_content.additional_properties = d
        return list_user_invites_response_content
