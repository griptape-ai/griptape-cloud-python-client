...
T = TypeVar("T", bound="CreateAssetResponseContent")


@_attrs_define
class CreateAssetResponseContent:
    """Attributes:
    ...
    contents: Unset | Any = UNSET
    size: Unset | float = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_asset_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            name=name,
            organization_id=organization_id,
        ...
        create_asset_response_content.additional_properties = d
