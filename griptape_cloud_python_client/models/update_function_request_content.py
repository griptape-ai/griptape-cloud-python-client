...
T = TypeVar("T", bound="UpdateFunctionRequestContent")


@_attrs_define
class UpdateFunctionRequestContent:
    """Attributes:
    ...
    function_config_file: Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.code, Unset):
            code = UNSET
        elif isinstance(self.code, FunctionCodeType0) or isinstance(self.code, FunctionCodeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_function_request_content = cls(
            code=code,
        ...
        update_function_request_content.additional_properties = d
