...
T = TypeVar("T", bound="CreateFunctionDeploymentRequestContent")


@_attrs_define
class CreateFunctionDeploymentRequestContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_function_deployment_request_content = cls(
            code_source=code_source,
            force=force,
        )

        create_function_deployment_request_content.additional_properties = d
