...
@_attrs_define
class CreateStructureRunResponseContent:
    """Attributes:
    args (list[str]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_structure_run_response_content = cls(
            args=args,
            completed_at=completed_at,
            created_at=created_at,
            created_by=created_by,
        ...
        create_structure_run_response_content.additional_properties = d
        return create_structure_run_response_content
