...
T = TypeVar("T", bound="UpdateRetrieverRequestContent")


@_attrs_define
class UpdateRetrieverRequestContent:
    """Attributes:
    ...
    retriever_component_ids: Unset | list[str] = UNSET
    retriever_components: Unset | list["RetrieverComponentInput"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        retriever_components: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_retriever_request_content = cls(
        ...
        update_retriever_request_content.additional_properties = d
        return update_retriever_request_content
