...
T = TypeVar("T", bound="CreateToolRequestContent")


@_attrs_define
class CreateToolRequestContent:
    """Attributes:
    name (str):
    ...
    tool_config_file: Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.code, Unset):
            code = UNSET
        elif isinstance(self.code, ToolCodeType0) or isinstance(self.code, ToolCodeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_tool_request_content = cls(
            name=name,
            code=code,
        ...
        create_tool_request_content.additional_properties = d
