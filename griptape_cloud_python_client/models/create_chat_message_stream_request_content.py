...
T = TypeVar("T", bound="CreateChatMessageStreamRequestContent")


@_attrs_define
class CreateChatMessageStreamRequestContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_chat_message_stream_request_content = cls(
            driver_configuration=driver_configuration,
            messages=messages,
            output_schema=output_schema,
            tools=tools,
        ...
        create_chat_message_stream_request_content.additional_properties = d
        return create_chat_message_stream_request_content
