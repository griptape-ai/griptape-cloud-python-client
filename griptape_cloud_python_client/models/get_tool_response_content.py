...
T = TypeVar("T", bound="GetToolResponseContent")


@_attrs_define
class GetToolResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_tool_response_content.additional_properties = d
        return get_tool_response_content
