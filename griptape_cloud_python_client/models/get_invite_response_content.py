...
T = TypeVar("T", bound="GetInviteResponseContent")


@_attrs_define
class GetInviteResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_invite_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            email=email,
            expires_at=expires_at,
        ...
        get_invite_response_content.additional_properties = d
        return get_invite_response_content
