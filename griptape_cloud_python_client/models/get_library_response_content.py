...
T = TypeVar("T", bound="GetLibraryResponseContent")


@_attrs_define
class GetLibraryResponseContent:
    """Attributes:
    assistant_id (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_library_response_content = cls(
            assistant_id=assistant_id,
            created_at=created_at,
            created_by=created_by,
            data_connector_ids=data_connector_ids,
        ...
        get_library_response_content.additional_properties = d
        return get_library_response_content
