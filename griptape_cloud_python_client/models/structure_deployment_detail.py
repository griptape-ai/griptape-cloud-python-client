...
T = TypeVar("T", bound="StructureDeploymentDetail")


@_attrs_define
class StructureDeploymentDetail:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        structure_deployment_detail = cls(
            code_source=code_source,
            created_at=created_at,
            created_by=created_by,
            deployment_id=deployment_id,
        ...
        structure_deployment_detail.additional_properties = d
