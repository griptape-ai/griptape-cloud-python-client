...
T = TypeVar("T", bound="CreateRetrieverResponseContent")


@_attrs_define
class CreateRetrieverResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_retriever_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            name=name,
            organization_id=organization_id,
        ...
        create_retriever_response_content.additional_properties = d
        return create_retriever_response_content
