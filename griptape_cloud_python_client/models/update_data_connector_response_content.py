...
T = TypeVar("T", bound="UpdateDataConnectorResponseContent")


@_attrs_define
class UpdateDataConnectorResponseContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        config: dict[str, Any]
        if (
            isinstance(self.config, DataConnectorConfigUnionType0)
            or isinstance(self.config, DataConnectorConfigUnionType1)
            or isinstance(self.config, DataConnectorConfigUnionType2)
            or isinstance(self.config, DataConnectorConfigUnionType3)
            or isinstance(self.config, DataConnectorConfigUnionType4)
        ):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_data_connector_response_content = cls(
            config=config,
            created_at=created_at,
            created_by=created_by,
            data_connector_id=data_connector_id,
        ...
        update_data_connector_response_content.additional_properties = d
        return update_data_connector_response_content
