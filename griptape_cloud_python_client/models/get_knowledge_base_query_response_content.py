...
T = TypeVar("T", bound="GetKnowledgeBaseQueryResponseContent")


@_attrs_define
class GetKnowledgeBaseQueryResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_knowledge_base_query_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            entries=entries,
            knowledge_base_id=knowledge_base_id,
        ...
        get_knowledge_base_query_response_content.additional_properties = d
        return get_knowledge_base_query_response_content
