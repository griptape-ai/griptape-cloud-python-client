...
T = TypeVar("T", bound="CreateMessageRequestContent")
...
class CreateMessageRequestContent:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata: Unset | Metadata
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = Metadata.from_dict(_metadata)

        create_message_request_content = cls(
            input_=input_,
            output=output,
            metadata=metadata,
        )

        create_message_request_content.additional_properties = d
