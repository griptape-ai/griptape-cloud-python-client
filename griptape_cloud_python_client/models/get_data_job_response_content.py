...
T = TypeVar("T", bound="GetDataJobResponseContent")


@_attrs_define
class GetDataJobResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_data_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            data_connector_id=data_connector_id,
            data_job_id=data_job_id,
        ...
        get_data_job_response_content.additional_properties = d
        return get_data_job_response_content
