...
T = TypeVar("T", bound="InvokeStructureWebhookPostResponseContent")


@_attrs_define
class InvokeStructureWebhookPostResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        invoke_structure_webhook_post_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        invoke_structure_webhook_post_response_content.additional_properties = d
