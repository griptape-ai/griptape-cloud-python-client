...
class UpdateIntegrationRequestContent:
    ...
    assistant_ids: Unset | list[str] = UNSET
    config: Union[
    ...
    type_: Unset | IntegrationType = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, Unset):
            config = UNSET
        elif isinstance(self.config, IntegrationConfigInputUnionType0) or isinstance(
            self.config, IntegrationConfigInputUnionType1
        ):
