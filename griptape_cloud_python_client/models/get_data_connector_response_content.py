...
T = TypeVar("T", bound="GetDataConnectorResponseContent")


@_attrs_define
class GetDataConnectorResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_data_connector_response_content = cls(
            config=config,
            created_at=created_at,
            created_by=created_by,
            data_connector_id=data_connector_id,
        ...
        get_data_connector_response_content.additional_properties = d
        return get_data_connector_response_content
