...
T = TypeVar("T", bound="GetToolRunResponseContent")


@_attrs_define
class GetToolRunResponseContent:
    """Attributes:
    ...
    completed_at: None | datetime.datetime
    created_at: datetime.datetime
    created_by: str
    input_: Any
    runtime_path: str
    started_at: None | datetime.datetime
    status: ToolRunStatus
    tool_id: str
    tool_run_id: str
    updated_at: datetime.datetime
    deployment_id: Unset | str = UNSET
    env_vars: Unset | list["EnvVar"] = UNSET
    output: Unset | Any = UNSET
    output_timestamp: Unset | float = UNSET
    status_detail: Unset | Any = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        env_vars: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_completed_at(data: object) -> None | datetime.datetime:
            if data is None:
                return data
            try:
        ...
        def _parse_started_at(data: object) -> None | datetime.datetime:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
        ...
        status = ToolRunStatus(d.pop("status"))

        tool_id = d.pop("tool_id")

        tool_run_id = d.pop("tool_run_id")
        ...
        get_tool_run_response_content = cls(
            completed_at=completed_at,
            created_at=created_at,
            created_by=created_by,
            input_=input_,
        ...
        get_tool_run_response_content.additional_properties = d
        return get_tool_run_response_content
