...
T = TypeVar("T", bound="CancelKnowledgeBaseJobResponseContent")


@_attrs_define
class CancelKnowledgeBaseJobResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        cancel_knowledge_base_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            knowledge_base_id=knowledge_base_id,
            knowledge_base_job_id=knowledge_base_job_id,
        ...
        cancel_knowledge_base_job_response_content.additional_properties = d
