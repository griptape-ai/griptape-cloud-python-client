...
T = TypeVar("T", bound="StructureRunDetail")


@_attrs_define
class StructureRunDetail:
    """Attributes:
    args (list[str]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        structure_run_detail.additional_properties = d
        return structure_run_detail
