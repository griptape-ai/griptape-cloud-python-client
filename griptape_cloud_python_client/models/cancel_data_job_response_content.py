...
T = TypeVar("T", bound="CancelDataJobResponseContent")


@_attrs_define
class CancelDataJobResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        cancel_data_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            data_connector_id=data_connector_id,
            data_job_id=data_job_id,
        ...
        cancel_data_job_response_content.additional_properties = d
        return cancel_data_job_response_content
