...
T = TypeVar("T", bound="UpdateKnowledgeBaseResponseContent")


@_attrs_define
class UpdateKnowledgeBaseResponseContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        config: dict[str, Any]
        if (
            isinstance(self.config, KnowledgeBaseConfigUnionType0)
            or isinstance(self.config, KnowledgeBaseConfigUnionType1)
            or isinstance(self.config, KnowledgeBaseConfigUnionType2)
        ):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_knowledge_base_response_content = cls(
            asset_paths=asset_paths,
            config=config,
            created_at=created_at,
            created_by=created_by,
        ...
        update_knowledge_base_response_content.additional_properties = d
        return update_knowledge_base_response_content
