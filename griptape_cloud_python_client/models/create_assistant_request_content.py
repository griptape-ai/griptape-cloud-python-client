...
T = TypeVar("T", bound="CreateAssistantRequestContent")


@_attrs_define
class CreateAssistantRequestContent:
    """Attributes:
    name (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_assistant_request_content = cls(
            name=name,
        ...
        create_assistant_request_content.additional_properties = d
