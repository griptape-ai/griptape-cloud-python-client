...
T = TypeVar("T", bound="CreateFunctionResponseContent")


@_attrs_define
class CreateFunctionResponseContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        code: dict[str, Any]
        if isinstance(self.code, FunctionCodeType0) or isinstance(self.code, FunctionCodeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_function_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        create_function_response_content.additional_properties = d
        return create_function_response_content
