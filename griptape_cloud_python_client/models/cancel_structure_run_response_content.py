...
T = TypeVar("T", bound="CancelStructureRunResponseContent")


@_attrs_define
class CancelStructureRunResponseContent:
    """Attributes:
    args (list[str]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        cancel_structure_run_response_content = cls(
            args=args,
            completed_at=completed_at,
            created_at=created_at,
            created_by=created_by,
        ...
        cancel_structure_run_response_content.additional_properties = d
        return cancel_structure_run_response_content
