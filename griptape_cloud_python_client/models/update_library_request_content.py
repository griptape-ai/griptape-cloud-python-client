...
T = TypeVar("T", bound="UpdateLibraryRequestContent")


@_attrs_define
class UpdateLibraryRequestContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for knowledge_base_configs_item_data in self.knowledge_base_configs:
            ...
            if (
                isinstance(knowledge_base_configs_item_data, KnowledgeBaseConfigInputUnionType0)
                or isinstance(knowledge_base_configs_item_data, KnowledgeBaseConfigInputUnionType1)
                or isinstance(knowledge_base_configs_item_data, KnowledgeBaseConfigInputUnionType2)
            ):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_library_request_content = cls(
            data_connector_ids=data_connector_ids,
            knowledge_base_configs=knowledge_base_configs,
            name=name,
        ...
        update_library_request_content.additional_properties = d
