...
T = TypeVar("T", bound="GetStructureResponseContent")


@_attrs_define
class GetStructureResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_structure_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        get_structure_response_content.additional_properties = d
