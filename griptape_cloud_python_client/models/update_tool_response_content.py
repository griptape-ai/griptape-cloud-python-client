...
T = TypeVar("T", bound="UpdateToolResponseContent")


@_attrs_define
class UpdateToolResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_tool_response_content = cls(
            code=code,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        update_tool_response_content.additional_properties = d
        return update_tool_response_content
