...
T = TypeVar("T", bound="GetAssistantResponseContent")


@_attrs_define
class GetAssistantResponseContent:
    """Attributes:
    assistant_id (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_assistant_response_content = cls(
            assistant_id=assistant_id,
            created_at=created_at,
            created_by=created_by,
            description=description,
        ...
        get_assistant_response_content.additional_properties = d
        return get_assistant_response_content
