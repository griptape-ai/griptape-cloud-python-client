...
T = TypeVar("T", bound="UpdateRetrieverResponseContent")
...
class UpdateRetrieverResponseContent:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_retriever_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            name=name,
            organization_id=organization_id,
        ...
        update_retriever_response_content.additional_properties = d
        return update_retriever_response_content
