...
T = TypeVar("T", bound="AssistantRunDetail")


@_attrs_define
class AssistantRunDetail:
    """Attributes:
    args (list[str]):
    assistant_id (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        assistant_run_detail.additional_properties = d
        return assistant_run_detail
