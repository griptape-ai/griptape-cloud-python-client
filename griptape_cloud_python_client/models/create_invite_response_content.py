...
T = TypeVar("T", bound="CreateInviteResponseContent")


@_attrs_define
class CreateInviteResponseContent:
    """Attributes:
    ...
    organization_id: str
    status: InviteStatus
    responded_at: Unset | datetime.datetime = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        responded_at: Unset | datetime.datetime
        if isinstance(_responded_at, Unset):
            responded_at = UNSET
        else:
            responded_at = isoparse(_responded_at)

        create_invite_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            email=email,
            expires_at=expires_at,
        ...
        create_invite_response_content.additional_properties = d
        return create_invite_response_content
