...
T = TypeVar("T", bound="GetKnowledgeBaseJobResponseContent")


@_attrs_define
class GetKnowledgeBaseJobResponseContent:
    """Attributes:
    ...
    knowledge_base_job_id: str
    status: KnowledgeBaseJobStatus
    bytes_ingested: Unset | float = UNSET
    completed_at: None | Unset | datetime.datetime = UNSET
    errors: Unset | list["Error"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        knowledge_base_job_id = self.knowledge_base_job_id
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        knowledge_base_job_id = d.pop("knowledge_base_job_id")

        status = KnowledgeBaseJobStatus(d.pop("status"))
        ...
        get_knowledge_base_job_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            knowledge_base_id=knowledge_base_id,
            knowledge_base_job_id=knowledge_base_job_id,
        ...
        get_knowledge_base_job_response_content.additional_properties = d
        return get_knowledge_base_job_response_content
