...
class CreateAssistantRunRequestContent:
    ...
    additional_knowledge_base_ids: Unset | list[str] = UNSET
    additional_retriever_ids: Unset | list[str] = UNSET
    additional_ruleset_ids: Unset | list[str] = UNSET
    additional_structure_ids: Unset | list[str] = UNSET
    additional_tool_ids: Unset | list[str] = UNSET
    args: Unset | list[str] = UNSET
    input_: Unset | str = UNSET
    knowledge_base_ids: Unset | list[str] = UNSET
    new_thread: Unset | bool = UNSET
    retriever_ids: Unset | list[str] = UNSET
    ruleset_ids: Unset | list[str] = UNSET
    stream: Unset | bool = UNSET
    structure_ids: Unset | list[str] = UNSET
    thread_id: Unset | str = UNSET
    tool_ids: Unset | list[str] = UNSET
