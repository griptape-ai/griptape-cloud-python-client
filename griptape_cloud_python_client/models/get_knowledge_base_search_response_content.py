...
T = TypeVar("T", bound="GetKnowledgeBaseSearchResponseContent")


@_attrs_define
class GetKnowledgeBaseSearchResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_knowledge_base_search_response_content = cls(
            created_at=created_at,
            created_by=created_by,
            knowledge_base_id=knowledge_base_id,
            knowledge_base_search_id=knowledge_base_search_id,
        ...
        get_knowledge_base_search_response_content.additional_properties = d
