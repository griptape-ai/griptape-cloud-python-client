...
T = TypeVar("T", bound="CreateKnowledgeBaseResponseContent")


@_attrs_define
class CreateKnowledgeBaseResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_knowledge_base_response_content = cls(
            asset_paths=asset_paths,
            config=config,
            created_at=created_at,
            created_by=created_by,
        ...
        create_knowledge_base_response_content.additional_properties = d
