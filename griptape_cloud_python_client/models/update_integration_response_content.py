...
T = TypeVar("T", bound="UpdateIntegrationResponseContent")


@_attrs_define
class UpdateIntegrationResponseContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        config: dict[str, Any]
        if isinstance(self.config, IntegrationConfigUnionType0) or isinstance(self.config, IntegrationConfigUnionType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_integration_response_content = cls(
            assistant_ids=assistant_ids,
            config=config,
            created_at=created_at,
            created_by=created_by,
        ...
        update_integration_response_content.additional_properties = d
        return update_integration_response_content
