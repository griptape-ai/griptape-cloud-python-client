...
T = TypeVar("T", bound="CreateFunctionDeploymentResponseContent")


@_attrs_define
class CreateFunctionDeploymentResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_function_deployment_response_content = cls(
            code_source=code_source,
            created_at=created_at,
            created_by=created_by,
            deployment_id=deployment_id,
        ...
        create_function_deployment_response_content.additional_properties = d
        return create_function_deployment_response_content
