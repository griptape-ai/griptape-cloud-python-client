...
T = TypeVar("T", bound="GetKnowledgeBaseResponseContent")


@_attrs_define
class GetKnowledgeBaseResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_knowledge_base_response_content = cls(
            asset_paths=asset_paths,
            config=config,
            created_at=created_at,
            created_by=created_by,
        ...
        get_knowledge_base_response_content.additional_properties = d
        return get_knowledge_base_response_content
