...
T = TypeVar("T", bound="FunctionDeploymentDetail")


@_attrs_define
class FunctionDeploymentDetail:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        function_deployment_detail = cls(
            code_source=code_source,
            created_at=created_at,
            created_by=created_by,
            deployment_id=deployment_id,
        ...
        function_deployment_detail.additional_properties = d
        return function_deployment_detail
