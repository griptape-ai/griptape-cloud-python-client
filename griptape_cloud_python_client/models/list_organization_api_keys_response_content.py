...
T = TypeVar("T", bound="ListOrganizationApiKeysResponseContent")


@_attrs_define
class ListOrganizationApiKeysResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        list_organization_api_keys_response_content = cls(
            api_keys=api_keys,
            pagination=pagination,
        )

        list_organization_api_keys_response_content.additional_properties = d
