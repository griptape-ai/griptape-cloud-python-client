...
T = TypeVar("T", bound="CreateStructureDeploymentRequestContent")


@_attrs_define
class CreateStructureDeploymentRequestContent:
    """Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        code_source: Unset | dict[str, Any]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_structure_deployment_request_content = cls(
            code_source=code_source,
            force=force,
        )

        create_structure_deployment_request_content.additional_properties = d
        return create_structure_deployment_request_content
