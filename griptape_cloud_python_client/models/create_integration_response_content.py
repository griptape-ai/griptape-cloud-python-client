...
T = TypeVar("T", bound="CreateIntegrationResponseContent")


@_attrs_define
class CreateIntegrationResponseContent:
    """Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_integration_response_content = cls(
            assistant_ids=assistant_ids,
            config=config,
            created_at=created_at,
            created_by=created_by,
        ...
        create_integration_response_content.additional_properties = d
        return create_integration_response_content
