...
T = TypeVar("T", bound="CancelAssistantRunResponseContent")


@_attrs_define
class CancelAssistantRunResponseContent:
    """Attributes:
    args (list[str]):
    assistant_id (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        cancel_assistant_run_response_content = cls(
            args=args,
            assistant_id=assistant_id,
            assistant_run_id=assistant_run_id,
            completed_at=completed_at,
        ...
        cancel_assistant_run_response_content.additional_properties = d
        return cancel_assistant_run_response_content
