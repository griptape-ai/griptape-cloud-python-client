...
class CreateDataConnectorRequestContent:
    ...
    transforms: Unset | list["TransformInput"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        config: dict[str, Any]
        if (
            isinstance(self.config, DataConnectorConfigInputUnionType0)
            or isinstance(self.config, DataConnectorConfigInputUnionType1)
            or isinstance(self.config, DataConnectorConfigInputUnionType2)
            or isinstance(self.config, DataConnectorConfigInputUnionType3)
            or isinstance(self.config, DataConnectorConfigInputUnionType4)
        ):
