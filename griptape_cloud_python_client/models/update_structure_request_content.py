...
T = TypeVar("T", bound="UpdateStructureRequestContent")


@_attrs_define
class UpdateStructureRequestContent:
    """Attributes:
    ...
    structure_config_file: Unset | str = UNSET
    webhook_enabled: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        code: Unset | dict[str, Any]
        if isinstance(self.code, Unset):
            code = UNSET
        elif isinstance(self.code, StructureCodeType0) or isinstance(self.code, StructureCodeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_structure_request_content = cls(
            code=code,
        ...
        update_structure_request_content.additional_properties = d
        return update_structure_request_content
