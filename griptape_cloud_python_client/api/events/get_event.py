...
from ...models.get_event_response_content import GetEventResponseContent
...
) -> ClientErrorResponseContent | GetEventResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetEventResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetEventResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetEventResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        event_id=event_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetEventResponseContent, ServiceErrorResponseContent]
    """
