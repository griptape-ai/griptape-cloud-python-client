...
from ...models.list_events_response_content import ListEventsResponseContent
...
) -> ClientErrorResponseContent | ListEventsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListEventsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListEventsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListEventsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListEventsResponseContent, ServiceErrorResponseContent]
    """
