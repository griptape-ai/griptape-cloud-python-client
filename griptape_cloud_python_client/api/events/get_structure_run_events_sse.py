...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/structure-runs/{structure_run_id}/events/stream",
    }
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | str | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | str]:
    return Response(
