...
from ...models.get_assistant_response_content import GetAssistantResponseContent
...
) -> ClientErrorResponseContent | GetAssistantResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetAssistantResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetAssistantResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetAssistantResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetAssistantResponseContent, ServiceErrorResponseContent]
    """
