...
from ...models.create_assistant_request_content import CreateAssistantRequestContent
from ...models.create_assistant_response_content import CreateAssistantResponseContent
...
def _get_kwargs(
    *,
    body: CreateAssistantRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | CreateAssistantResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateAssistantResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateAssistantResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateAssistantResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateAssistantResponseContent, ServiceErrorResponseContent]
    """
