...
from ...models.create_function_request_content import CreateFunctionRequestContent
from ...models.create_function_response_content import CreateFunctionResponseContent
...
def _get_kwargs(
    *,
    body: CreateFunctionRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | CreateFunctionResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateFunctionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateFunctionResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateFunctionResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateFunctionResponseContent, ServiceErrorResponseContent]
    """
