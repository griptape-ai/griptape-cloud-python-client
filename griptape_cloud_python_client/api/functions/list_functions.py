...
from ...models.list_functions_response_content import ListFunctionsResponseContent
...
) -> ClientErrorResponseContent | ListFunctionsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListFunctionsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListFunctionsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListFunctionsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        page=page,
        page_size=page_size,
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListFunctionsResponseContent, ServiceErrorResponseContent]
    """
