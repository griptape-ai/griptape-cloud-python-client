...
from ...models.update_function_response_content import UpdateFunctionResponseContent
...
def _get_kwargs(
    function_id: str,
    *,
    body: UpdateFunctionRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateFunctionResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateFunctionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateFunctionResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateFunctionResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateFunctionResponseContent]
    """
