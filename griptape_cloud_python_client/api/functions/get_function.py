...
from ...models.get_function_response_content import GetFunctionResponseContent
...
) -> ClientErrorResponseContent | GetFunctionResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetFunctionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetFunctionResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetFunctionResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetFunctionResponseContent, ServiceErrorResponseContent]
    """
