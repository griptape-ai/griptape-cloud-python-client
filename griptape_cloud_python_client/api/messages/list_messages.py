...
from ...models.list_messages_response_content import ListMessagesResponseContent
...
) -> ClientErrorResponseContent | ListMessagesResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListMessagesResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListMessagesResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListMessagesResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        thread_id=thread_id,
        page=page,
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListMessagesResponseContent, ServiceErrorResponseContent]
    """
