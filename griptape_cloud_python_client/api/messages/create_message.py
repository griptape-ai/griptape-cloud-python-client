...
from ...models.create_message_request_content import CreateMessageRequestContent
...
) -> ClientErrorResponseContent | CreateMessageResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateMessageResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateMessageResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateMessageResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        thread_id=thread_id,
        body=body,
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateMessageResponseContent, ServiceErrorResponseContent]
    """
