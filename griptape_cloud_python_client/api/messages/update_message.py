...
from ...models.update_message_request_content import UpdateMessageRequestContent
from ...models.update_message_response_content import UpdateMessageResponseContent
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateMessageResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateMessageResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateMessageResponseContent]:
    return Response(
