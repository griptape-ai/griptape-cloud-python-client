...
from ...models.list_spans_response_content import ListSpansResponseContent
...
) -> ClientErrorResponseContent | ListSpansResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListSpansResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListSpansResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListSpansResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListSpansResponseContent, ServiceErrorResponseContent]
    """
