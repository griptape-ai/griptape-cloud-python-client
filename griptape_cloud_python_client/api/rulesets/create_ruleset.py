...
) -> ClientErrorResponseContent | CreateRulesetResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateRulesetResponseContent | ServiceErrorResponseContent]:
    return Response(
