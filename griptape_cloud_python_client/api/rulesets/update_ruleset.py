...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRulesetResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRulesetResponseContent]:
    return Response(
