...
from ...models.get_ruleset_response_content import GetRulesetResponseContent
...
) -> ClientErrorResponseContent | GetRulesetResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetRulesetResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetRulesetResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetRulesetResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetRulesetResponseContent, ServiceErrorResponseContent]
    """
