...
) -> ClientErrorResponseContent | ListRulesetsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListRulesetsResponseContent | ServiceErrorResponseContent]:
    return Response(
