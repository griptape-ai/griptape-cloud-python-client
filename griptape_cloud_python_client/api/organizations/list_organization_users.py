...
) -> ClientErrorResponseContent | ListOrganizationUsersResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListOrganizationUsersResponseContent | ServiceErrorResponseContent]:
    return Response(
