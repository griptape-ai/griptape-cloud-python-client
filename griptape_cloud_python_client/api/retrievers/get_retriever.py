...
) -> ClientErrorResponseContent | GetRetrieverResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetRetrieverResponseContent | ServiceErrorResponseContent]:
    return Response(
