...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRetrieverResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRetrieverResponseContent]:
    return Response(
