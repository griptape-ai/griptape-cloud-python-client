...
from ...models.create_retriever_request_content import CreateRetrieverRequestContent
from ...models.create_retriever_response_content import CreateRetrieverResponseContent
...
def _get_kwargs(
    *,
    body: CreateRetrieverRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | CreateRetrieverResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateRetrieverResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateRetrieverResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateRetrieverResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateRetrieverResponseContent, ServiceErrorResponseContent]
    """
