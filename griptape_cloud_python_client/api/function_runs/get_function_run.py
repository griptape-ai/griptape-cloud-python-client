...
from ...models.get_function_run_response_content import GetFunctionRunResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/function-runs/{function_run_id}",
    }
...
) -> ClientErrorResponseContent | GetFunctionRunResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetFunctionRunResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetFunctionRunResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetFunctionRunResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetFunctionRunResponseContent, ServiceErrorResponseContent]
    """
