...
) -> ClientErrorResponseContent | ListFunctionRunLogsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListFunctionRunLogsResponseContent | ServiceErrorResponseContent]:
    return Response(
