...
def _get_kwargs(
    ...
    *,
    ...
    status: Unset | list[FunctionRunStatus] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> ClientErrorResponseContent | ListFunctionRunsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListFunctionRunsResponseContent | ServiceErrorResponseContent]:
    return Response(
