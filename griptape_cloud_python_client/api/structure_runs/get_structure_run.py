...
from ...models.get_structure_run_response_content import GetStructureRunResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/structure-runs/{structure_run_id}",
    }
...
) -> ClientErrorResponseContent | GetStructureRunResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetStructureRunResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetStructureRunResponseContent | ServiceErrorResponseContent]:
    return Response(
