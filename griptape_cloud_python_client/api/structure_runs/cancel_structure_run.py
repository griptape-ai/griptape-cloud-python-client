...
from ...models.cancel_structure_run_response_content import CancelStructureRunResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/structure-runs/{structure_run_id}/cancel",
    }
...
) -> CancelStructureRunResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = CancelStructureRunResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CancelStructureRunResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[CancelStructureRunResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CancelStructureRunResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]
    """
