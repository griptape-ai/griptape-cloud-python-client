...
from ...models.list_structure_run_logs_response_content import ListStructureRunLogsResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/structure-runs/{structure_run_id}/logs",
    }
...
) -> ClientErrorResponseContent | ListStructureRunLogsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListStructureRunLogsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListStructureRunLogsResponseContent | ServiceErrorResponseContent]:
    return Response(
