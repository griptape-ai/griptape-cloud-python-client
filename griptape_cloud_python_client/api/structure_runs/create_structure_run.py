...
from ...models.create_structure_run_request_content import CreateStructureRunRequestContent
from ...models.create_structure_run_response_content import CreateStructureRunResponseContent
...
) -> ClientErrorResponseContent | CreateStructureRunResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateStructureRunResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateStructureRunResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateStructureRunResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateStructureRunResponseContent, ServiceErrorResponseContent]
    """
