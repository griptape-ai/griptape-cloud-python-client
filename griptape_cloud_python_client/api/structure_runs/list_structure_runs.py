...
def _get_kwargs(
    ...
    *,
    ...
    status: Unset | list[StructureRunStatus] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> ClientErrorResponseContent | ListStructureRunsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListStructureRunsResponseContent | ServiceErrorResponseContent]:
    return Response(
