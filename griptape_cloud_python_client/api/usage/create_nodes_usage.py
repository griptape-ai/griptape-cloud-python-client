...
from ...models.create_nodes_usage_request_content import CreateNodesUsageRequestContent
...
def _get_kwargs(
    *,
    body: CreateNodesUsageRequestContent,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/usage/report/nodes",
    }
...
) -> Any | ClientErrorResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ClientErrorResponseContent | ServiceErrorResponseContent]:
    return Response(
