...
from ...models.get_usage_response_content import GetUsageResponseContent
...
) -> ClientErrorResponseContent | GetUsageResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetUsageResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetUsageResponseContent | ServiceErrorResponseContent]:
    return Response(
