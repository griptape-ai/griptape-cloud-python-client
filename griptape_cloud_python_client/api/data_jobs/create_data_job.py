...
) -> ClientErrorResponseContent | CreateDataJobResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateDataJobResponseContent | ServiceErrorResponseContent]:
    return Response(
