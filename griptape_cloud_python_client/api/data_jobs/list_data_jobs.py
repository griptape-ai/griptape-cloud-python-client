...
def _get_kwargs(
    ...
    *,
    ...
    status: Unset | list[DataJobStatus] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> ClientErrorResponseContent | ListDataJobsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListDataJobsResponseContent | ServiceErrorResponseContent]:
    return Response(
