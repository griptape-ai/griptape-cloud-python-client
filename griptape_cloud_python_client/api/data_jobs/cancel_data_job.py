...
) -> CancelDataJobResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CancelDataJobResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent]:
    return Response(
