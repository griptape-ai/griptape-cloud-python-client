...
from ...models.get_data_job_response_content import GetDataJobResponseContent
...
) -> ClientErrorResponseContent | GetDataJobResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetDataJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetDataJobResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetDataJobResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetDataJobResponseContent, ServiceErrorResponseContent]
    """
