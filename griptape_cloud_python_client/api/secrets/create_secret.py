...
) -> ClientErrorResponseContent | CreateSecretResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateSecretResponseContent | ServiceErrorResponseContent]:
    return Response(
