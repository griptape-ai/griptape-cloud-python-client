...
) -> ClientErrorResponseContent | GetSecretResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetSecretResponseContent | ServiceErrorResponseContent]:
    return Response(
