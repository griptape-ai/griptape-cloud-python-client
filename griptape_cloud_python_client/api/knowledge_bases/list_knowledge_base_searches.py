...
from ...models.list_knowledge_base_searches_response_content import ListKnowledgeBaseSearchesResponseContent
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/knowledge-bases/{knowledge_base_id}/searches",
        "params": params,
    }
...
) -> ClientErrorResponseContent | ListKnowledgeBaseSearchesResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListKnowledgeBaseSearchesResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListKnowledgeBaseSearchesResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListKnowledgeBaseSearchesResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListKnowledgeBaseSearchesResponseContent, ServiceErrorResponseContent]
    """
