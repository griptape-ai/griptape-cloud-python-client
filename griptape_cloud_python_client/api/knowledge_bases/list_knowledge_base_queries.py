...
from ...models.list_knowledge_base_queries_response_content import ListKnowledgeBaseQueriesResponseContent
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/knowledge-bases/{knowledge_base_id}/queries",
        "params": params,
    }
...
) -> ClientErrorResponseContent | ListKnowledgeBaseQueriesResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListKnowledgeBaseQueriesResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListKnowledgeBaseQueriesResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListKnowledgeBaseQueriesResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListKnowledgeBaseQueriesResponseContent, ServiceErrorResponseContent]
    """
