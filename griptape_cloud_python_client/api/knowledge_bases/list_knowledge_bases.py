...
from ...models.list_knowledge_bases_response_content import ListKnowledgeBasesResponseContent
...
) -> ClientErrorResponseContent | ListKnowledgeBasesResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListKnowledgeBasesResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListKnowledgeBasesResponseContent | ServiceErrorResponseContent]:
    return Response(
