...
) -> ClientErrorResponseContent | QueryKnowledgeBaseResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | QueryKnowledgeBaseResponseContent | ServiceErrorResponseContent]:
    return Response(
