...
) -> ClientErrorResponseContent | SearchKnowledgeBaseResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | SearchKnowledgeBaseResponseContent | ServiceErrorResponseContent]:
    return Response(
