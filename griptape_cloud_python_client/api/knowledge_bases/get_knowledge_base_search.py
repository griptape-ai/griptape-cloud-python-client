...
from ...models.get_knowledge_base_search_response_content import GetKnowledgeBaseSearchResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/knowledge-base-searches/{knowledge_base_search_id}",
    }
...
) -> ClientErrorResponseContent | GetKnowledgeBaseSearchResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetKnowledgeBaseSearchResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetKnowledgeBaseSearchResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetKnowledgeBaseSearchResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetKnowledgeBaseSearchResponseContent, ServiceErrorResponseContent]
    """
