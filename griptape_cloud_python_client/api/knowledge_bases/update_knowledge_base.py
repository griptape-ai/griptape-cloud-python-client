...
from ...models.update_knowledge_base_response_content import UpdateKnowledgeBaseResponseContent
...
def _get_kwargs(
    ...
    *,
    body: UpdateKnowledgeBaseRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateKnowledgeBaseResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateKnowledgeBaseResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateKnowledgeBaseResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateKnowledgeBaseResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateKnowledgeBaseResponseContent]
    """
