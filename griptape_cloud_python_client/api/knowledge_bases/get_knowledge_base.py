...
) -> ClientErrorResponseContent | GetKnowledgeBaseResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetKnowledgeBaseResponseContent | ServiceErrorResponseContent]:
    return Response(
