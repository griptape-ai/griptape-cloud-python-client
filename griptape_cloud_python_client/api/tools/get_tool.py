...
from ...models.get_tool_response_content import GetToolResponseContent
...
) -> ClientErrorResponseContent | GetToolResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetToolResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetToolResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetToolResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        tool_id=tool_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetToolResponseContent, ServiceErrorResponseContent]
    """
