...
from ...models.create_tool_request_content import CreateToolRequestContent
from ...models.create_tool_response_content import CreateToolResponseContent
...
) -> ClientErrorResponseContent | CreateToolResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateToolResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateToolResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateToolResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateToolResponseContent, ServiceErrorResponseContent]
    """
