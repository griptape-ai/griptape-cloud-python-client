...
from ...models.list_tools_response_content import ListToolsResponseContent
...
) -> ClientErrorResponseContent | ListToolsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListToolsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListToolsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListToolsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        page=page,
        page_size=page_size,
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListToolsResponseContent, ServiceErrorResponseContent]
    """
