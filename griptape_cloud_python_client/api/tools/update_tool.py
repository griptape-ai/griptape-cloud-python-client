...
from ...models.update_tool_request_content import UpdateToolRequestContent
from ...models.update_tool_response_content import UpdateToolResponseContent
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateToolResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateToolResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateToolResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateToolResponseContent]]
    """
    kwargs = _get_kwargs(
        tool_id=tool_id,
        body=body,
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateToolResponseContent]
    """
