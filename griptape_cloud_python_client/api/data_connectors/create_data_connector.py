...
from ...models.create_data_connector_request_content import CreateDataConnectorRequestContent
from ...models.create_data_connector_response_content import CreateDataConnectorResponseContent
...
def _get_kwargs(
    *,
    body: CreateDataConnectorRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | CreateDataConnectorResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateDataConnectorResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateDataConnectorResponseContent | ServiceErrorResponseContent]:
    return Response(
