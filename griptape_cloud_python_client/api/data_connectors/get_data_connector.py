...
from ...models.get_data_connector_response_content import GetDataConnectorResponseContent
...
) -> ClientErrorResponseContent | GetDataConnectorResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetDataConnectorResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetDataConnectorResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetDataConnectorResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetDataConnectorResponseContent, ServiceErrorResponseContent]
    """
