...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateDataConnectorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateDataConnectorResponseContent]:
    return Response(
