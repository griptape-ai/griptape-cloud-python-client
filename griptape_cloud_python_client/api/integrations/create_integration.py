...
from ...models.create_integration_request_content import CreateIntegrationRequestContent
from ...models.create_integration_response_content import CreateIntegrationResponseContent
...
) -> ClientErrorResponseContent | CreateIntegrationResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateIntegrationResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateIntegrationResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateIntegrationResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateIntegrationResponseContent, ServiceErrorResponseContent]
    """
