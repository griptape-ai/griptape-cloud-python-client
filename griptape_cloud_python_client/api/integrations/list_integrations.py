...
from ...models.list_integrations_response_content import ListIntegrationsResponseContent
...
) -> ClientErrorResponseContent | ListIntegrationsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListIntegrationsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListIntegrationsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListIntegrationsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        page=page,
        page_size=page_size,
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListIntegrationsResponseContent, ServiceErrorResponseContent]
    """
