...
from ...models.get_integration_response_content import GetIntegrationResponseContent
...
) -> ClientErrorResponseContent | GetIntegrationResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetIntegrationResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetIntegrationResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetIntegrationResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetIntegrationResponseContent, ServiceErrorResponseContent]
    """
