...
from ...models.update_integration_response_content import UpdateIntegrationResponseContent
...
def _get_kwargs(
    integration_id: str,
    *,
    body: UpdateIntegrationRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateIntegrationResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateIntegrationResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateIntegrationResponseContent]:
    return Response(
