...
) -> CancelAssistantRunResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CancelAssistantRunResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent]:
    return Response(
