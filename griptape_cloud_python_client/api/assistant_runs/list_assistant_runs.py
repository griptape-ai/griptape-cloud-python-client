...
def _get_kwargs(
    ...
    *,
    ...
    status: Unset | list[AssistantRunStatus] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> ClientErrorResponseContent | ListAssistantRunsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListAssistantRunsResponseContent | ServiceErrorResponseContent]:
    return Response(
