...
from ...models.get_assistant_run_response_content import GetAssistantRunResponseContent
...
) -> ClientErrorResponseContent | GetAssistantRunResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetAssistantRunResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetAssistantRunResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetAssistantRunResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetAssistantRunResponseContent, ServiceErrorResponseContent]
    """
