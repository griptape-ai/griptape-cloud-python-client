...
) -> ClientErrorResponseContent | CreateAssistantRunResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateAssistantRunResponseContent | ServiceErrorResponseContent]:
    return Response(
