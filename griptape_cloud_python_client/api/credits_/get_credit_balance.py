...
from ...models.get_credit_balance_response_content import GetCreditBalanceResponseContent
...
) -> ClientErrorResponseContent | GetCreditBalanceResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetCreditBalanceResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetCreditBalanceResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetCreditBalanceResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs()
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetCreditBalanceResponseContent, ServiceErrorResponseContent]
    """
