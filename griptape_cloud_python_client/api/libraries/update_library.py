...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateLibraryResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateLibraryResponseContent]:
    return Response(
