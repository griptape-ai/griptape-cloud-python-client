...
from ...models.get_library_response_content import GetLibraryResponseContent
...
) -> ClientErrorResponseContent | GetLibraryResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetLibraryResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetLibraryResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetLibraryResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetLibraryResponseContent, ServiceErrorResponseContent]
    """
