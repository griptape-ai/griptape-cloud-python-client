...
from ...models.create_connection_request_content import CreateConnectionRequestContent
from ...models.create_connection_response_content import CreateConnectionResponseContent
...
def _get_kwargs(
    *,
    body: CreateConnectionRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | CreateConnectionResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateConnectionResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateConnectionResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateConnectionResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateConnectionResponseContent, ServiceErrorResponseContent]
    """
