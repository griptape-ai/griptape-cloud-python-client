...
) -> ClientErrorResponseContent | GetTokenResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetTokenResponseContent | ServiceErrorResponseContent]:
    return Response(
