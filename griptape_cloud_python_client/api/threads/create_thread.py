...
from ...models.create_thread_request_content import CreateThreadRequestContent
from ...models.create_thread_response_content import CreateThreadResponseContent
...
def _get_kwargs(
    *,
    body: CreateThreadRequestContent,
) -> dict[str, Any]:
...
) -> ClientErrorResponseContent | CreateThreadResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateThreadResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateThreadResponseContent | ServiceErrorResponseContent]:
    return Response(
