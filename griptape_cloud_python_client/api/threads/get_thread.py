...
from ...models.get_thread_response_content import GetThreadResponseContent
...
) -> ClientErrorResponseContent | GetThreadResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetThreadResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetThreadResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetThreadResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        thread_id=thread_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetThreadResponseContent, ServiceErrorResponseContent]
    """
