...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateThreadResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateThreadResponseContent]:
    return Response(
