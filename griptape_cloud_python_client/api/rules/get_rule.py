...
from ...models.get_rule_response_content import GetRuleResponseContent
...
) -> ClientErrorResponseContent | GetRuleResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetRuleResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetRuleResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetRuleResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        rule_id=rule_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetRuleResponseContent, ServiceErrorResponseContent]
    """
