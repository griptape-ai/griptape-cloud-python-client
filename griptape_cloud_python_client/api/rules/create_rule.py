...
from ...models.create_rule_request_content import CreateRuleRequestContent
from ...models.create_rule_response_content import CreateRuleResponseContent
...
) -> ClientErrorResponseContent | CreateRuleResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateRuleResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateRuleResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateRuleResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateRuleResponseContent, ServiceErrorResponseContent]
    """
