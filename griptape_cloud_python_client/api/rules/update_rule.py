...
from ...models.update_rule_request_content import UpdateRuleRequestContent
from ...models.update_rule_response_content import UpdateRuleResponseContent
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRuleResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateRuleResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRuleResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateRuleResponseContent]]
    """
    kwargs = _get_kwargs(
        rule_id=rule_id,
        body=body,
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateRuleResponseContent]
    """
