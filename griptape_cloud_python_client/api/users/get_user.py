...
from ...models.get_user_response_content import GetUserResponseContent
...
) -> ClientErrorResponseContent | GetUserResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetUserResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetUserResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetUserResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        user_id=user_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetUserResponseContent, ServiceErrorResponseContent]
    """
