...
from ...models.list_tool_run_logs_response_content import ListToolRunLogsResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/tool-runs/{tool_run_id}/logs",
    }
...
) -> ClientErrorResponseContent | ListToolRunLogsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListToolRunLogsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListToolRunLogsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListToolRunLogsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListToolRunLogsResponseContent, ServiceErrorResponseContent]
    """
