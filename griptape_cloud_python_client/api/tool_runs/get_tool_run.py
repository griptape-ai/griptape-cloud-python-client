...
from ...models.get_tool_run_response_content import GetToolRunResponseContent
...
) -> ClientErrorResponseContent | GetToolRunResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetToolRunResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetToolRunResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetToolRunResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetToolRunResponseContent, ServiceErrorResponseContent]
    """
