...
from ...models.list_organization_api_keys_response_content import ListOrganizationApiKeysResponseContent
...
) -> ClientErrorResponseContent | ListOrganizationApiKeysResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListOrganizationApiKeysResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListOrganizationApiKeysResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListOrganizationApiKeysResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListOrganizationApiKeysResponseContent, ServiceErrorResponseContent]
    """
