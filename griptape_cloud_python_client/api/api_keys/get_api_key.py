...
) -> ClientErrorResponseContent | GetApiKeyResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetApiKeyResponseContent | ServiceErrorResponseContent]:
    return Response(
