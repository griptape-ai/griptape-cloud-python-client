...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateApiKeyResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateApiKeyResponseContent]:
    return Response(
