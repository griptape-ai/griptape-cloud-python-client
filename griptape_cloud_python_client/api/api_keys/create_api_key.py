...
) -> ClientErrorResponseContent | CreateApiKeyResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateApiKeyResponseContent | ServiceErrorResponseContent]:
    return Response(
