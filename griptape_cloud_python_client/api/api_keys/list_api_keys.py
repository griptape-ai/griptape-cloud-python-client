...
from ...models.list_api_keys_response_content import ListApiKeysResponseContent
...
) -> ClientErrorResponseContent | ListApiKeysResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListApiKeysResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListApiKeysResponseContent | ServiceErrorResponseContent]:
    return Response(
