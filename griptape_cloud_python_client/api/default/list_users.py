...
from ...models.list_users_response_content import ListUsersResponseContent
...
) -> ClientErrorResponseContent | ListUsersResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListUsersResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListUsersResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListUsersResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs()
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListUsersResponseContent, ServiceErrorResponseContent]
    """
