...
from ...models.create_billing_management_url_response_content import CreateBillingManagementUrlResponseContent
...
) -> ClientErrorResponseContent | CreateBillingManagementUrlResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateBillingManagementUrlResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateBillingManagementUrlResponseContent | ServiceErrorResponseContent]:
    return Response(
