...
) -> ClientErrorResponseContent | CreateInviteResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateInviteResponseContent | ServiceErrorResponseContent]:
    return Response(
