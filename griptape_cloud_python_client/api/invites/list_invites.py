...
from ...models.list_invites_response_content import ListInvitesResponseContent
...
) -> ClientErrorResponseContent | ListInvitesResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListInvitesResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListInvitesResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListInvitesResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListInvitesResponseContent, ServiceErrorResponseContent]
    """
