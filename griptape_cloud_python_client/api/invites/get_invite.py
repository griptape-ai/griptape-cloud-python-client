...
from ...models.get_invite_response_content import GetInviteResponseContent
...
) -> ClientErrorResponseContent | GetInviteResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetInviteResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetInviteResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetInviteResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        invite_id=invite_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetInviteResponseContent, ServiceErrorResponseContent]
    """
