...
) -> ClientErrorResponseContent | InvokeStructureWebhookGetResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | InvokeStructureWebhookGetResponseContent | ServiceErrorResponseContent]:
    return Response(
