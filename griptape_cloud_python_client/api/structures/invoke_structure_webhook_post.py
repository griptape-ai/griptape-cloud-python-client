...
) -> ClientErrorResponseContent | InvokeStructureWebhookPostResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | InvokeStructureWebhookPostResponseContent | ServiceErrorResponseContent]:
    return Response(
