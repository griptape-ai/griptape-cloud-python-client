...
from ...models.get_structure_response_content import GetStructureResponseContent
...
) -> ClientErrorResponseContent | GetStructureResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetStructureResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetStructureResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetStructureResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetStructureResponseContent, ServiceErrorResponseContent]
    """
