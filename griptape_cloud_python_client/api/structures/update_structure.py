...
from ...models.update_structure_request_content import UpdateStructureRequestContent
from ...models.update_structure_response_content import UpdateStructureResponseContent
...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateStructureResponseContent | None:
    if response.status_code == 200:
        response_200 = UpdateStructureResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateStructureResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateStructureResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ServiceErrorResponseContent, UpdateStructureResponseContent]
    """
