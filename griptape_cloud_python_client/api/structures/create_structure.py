...
from ...models.create_structure_request_content import CreateStructureRequestContent
from ...models.create_structure_response_content import CreateStructureResponseContent
...
) -> ClientErrorResponseContent | CreateStructureResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 201:
        response_201 = CreateStructureResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateStructureResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateStructureResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        body=body,
    )
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateStructureResponseContent, ServiceErrorResponseContent]
    """
