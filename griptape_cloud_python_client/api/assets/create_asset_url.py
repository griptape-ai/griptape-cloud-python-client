...
) -> ClientErrorResponseContent | CreateAssetUrlResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateAssetUrlResponseContent | ServiceErrorResponseContent]:
    return Response(
