...
from ...models.create_asset_request_content import CreateAssetRequestContent
from ...models.create_asset_response_content import CreateAssetResponseContent
...
) -> ClientErrorResponseContent | CreateAssetResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = CreateAssetResponseContent.from_dict(response.json())

        return response_200

    if response.status_code == 201:
        response_201 = CreateAssetResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateAssetResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateAssetResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        bucket_id=bucket_id,
        body=body,
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateAssetResponseContent, ServiceErrorResponseContent]
    """
