...
def _get_kwargs(
    ...
    name: str,
    *,
    include_contents: Unset | bool = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> ClientErrorResponseContent | GetAssetResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetAssetResponseContent | ServiceErrorResponseContent]:
    return Response(
