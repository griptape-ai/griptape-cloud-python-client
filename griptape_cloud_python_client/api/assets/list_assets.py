...
) -> ClientErrorResponseContent | ListAssetsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListAssetsResponseContent | ServiceErrorResponseContent]:
    return Response(
