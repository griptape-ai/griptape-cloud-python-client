...
from ...models.get_deployment_response_content import GetDeploymentResponseContent
...
) -> ClientErrorResponseContent | GetDeploymentResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetDeploymentResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetDeploymentResponseContent | ServiceErrorResponseContent]:
    return Response(
