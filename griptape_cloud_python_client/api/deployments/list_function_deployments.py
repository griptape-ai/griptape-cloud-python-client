...
from ...models.list_function_deployments_response_content import ListFunctionDeploymentsResponseContent
...
) -> ClientErrorResponseContent | ListFunctionDeploymentsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListFunctionDeploymentsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListFunctionDeploymentsResponseContent | ServiceErrorResponseContent]:
    return Response(
