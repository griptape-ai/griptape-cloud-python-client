...
from ...models.list_tool_deployments_response_content import ListToolDeploymentsResponseContent
...
) -> ClientErrorResponseContent | ListToolDeploymentsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListToolDeploymentsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListToolDeploymentsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListToolDeploymentsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        tool_id=tool_id,
        page=page,
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListToolDeploymentsResponseContent, ServiceErrorResponseContent]
    """
