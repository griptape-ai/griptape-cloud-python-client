...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRetrieverComponentResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateRetrieverComponentResponseContent]:
    return Response(
