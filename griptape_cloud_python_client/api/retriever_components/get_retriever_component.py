...
from ...models.get_retriever_component_response_content import GetRetrieverComponentResponseContent
...
) -> ClientErrorResponseContent | GetRetrieverComponentResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetRetrieverComponentResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetRetrieverComponentResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetRetrieverComponentResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetRetrieverComponentResponseContent, ServiceErrorResponseContent]
    """
