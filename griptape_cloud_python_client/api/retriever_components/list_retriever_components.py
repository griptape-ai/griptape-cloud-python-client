...
from ...models.list_retriever_components_response_content import ListRetrieverComponentsResponseContent
...
) -> ClientErrorResponseContent | ListRetrieverComponentsResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = ListRetrieverComponentsResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListRetrieverComponentsResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, ListRetrieverComponentsResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        page=page,
        page_size=page_size,
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, ListRetrieverComponentsResponseContent, ServiceErrorResponseContent]
    """
