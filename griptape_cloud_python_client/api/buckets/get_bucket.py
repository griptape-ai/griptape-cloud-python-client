...
from ...models.get_bucket_response_content import GetBucketResponseContent
...
) -> ClientErrorResponseContent | GetBucketResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetBucketResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetBucketResponseContent | ServiceErrorResponseContent]:
    return Response(
