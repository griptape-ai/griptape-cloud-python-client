...
) -> ClientErrorResponseContent | CreateBucketResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateBucketResponseContent | ServiceErrorResponseContent]:
    return Response(
