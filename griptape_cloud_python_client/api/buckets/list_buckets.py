...
) -> ClientErrorResponseContent | ListBucketsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListBucketsResponseContent | ServiceErrorResponseContent]:
    return Response(
