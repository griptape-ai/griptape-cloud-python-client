...
) -> ClientErrorResponseContent | ServiceErrorResponseContent | UpdateBucketResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ServiceErrorResponseContent | UpdateBucketResponseContent]:
    return Response(
