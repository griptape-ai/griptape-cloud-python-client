...
from ...models.get_config_response_content import GetConfigResponseContent
...
) -> ClientErrorResponseContent | GetConfigResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetConfigResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetConfigResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, GetConfigResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs()
...
def sync(
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, GetConfigResponseContent, ServiceErrorResponseContent]
    """
