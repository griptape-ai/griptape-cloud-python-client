...
from ...models.create_knowledge_base_job_response_content import CreateKnowledgeBaseJobResponseContent
...
) -> ClientErrorResponseContent | CreateKnowledgeBaseJobResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 202:
        response_202 = CreateKnowledgeBaseJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | CreateKnowledgeBaseJobResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ClientErrorResponseContent, CreateKnowledgeBaseJobResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ClientErrorResponseContent, CreateKnowledgeBaseJobResponseContent, ServiceErrorResponseContent]
    """
