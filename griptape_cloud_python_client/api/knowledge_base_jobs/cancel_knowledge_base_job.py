...
from ...models.cancel_knowledge_base_job_response_content import CancelKnowledgeBaseJobResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/knowledge-base-jobs/{knowledge_base_job_id}/cancel",
    }
...
) -> CancelKnowledgeBaseJobResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = CancelKnowledgeBaseJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CancelKnowledgeBaseJobResponseContent | ClientErrorResponseContent | ServiceErrorResponseContent]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[CancelKnowledgeBaseJobResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]]
    """
    kwargs = _get_kwargs(
        knowledge_base_job_id=knowledge_base_job_id,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CancelKnowledgeBaseJobResponseContent, ClientErrorResponseContent, ServiceErrorResponseContent]
    """
