...
from ...models.get_knowledge_base_job_response_content import GetKnowledgeBaseJobResponseContent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/knowledge-base-jobs/{knowledge_base_job_id}",
    }
...
) -> ClientErrorResponseContent | GetKnowledgeBaseJobResponseContent | ServiceErrorResponseContent | None:
    if response.status_code == 200:
        response_200 = GetKnowledgeBaseJobResponseContent.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | GetKnowledgeBaseJobResponseContent | ServiceErrorResponseContent]:
    return Response(
