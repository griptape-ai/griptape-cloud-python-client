...
def _get_kwargs(
    ...
    *,
    ...
    status: Unset | list[KnowledgeBaseJobStatus] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> ClientErrorResponseContent | ListKnowledgeBaseJobsResponseContent | ServiceErrorResponseContent | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClientErrorResponseContent | ListKnowledgeBaseJobsResponseContent | ServiceErrorResponseContent]:
    return Response(
